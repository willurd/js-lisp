...
(setq symbols
	'(("Symbols"
	  ...
	  ("I"
		...
		(:name "is-null" :status "notDone" :type "function" :notes "Renamed from \"null\".")
	  ...
	  ("S"
		...
		(:name "sort" :status "done" :type "function" :notes "")
	  ...
	  ("T"
		...
		(:name "to-lower" :status "done" :type "function" :notes "Renamed from \"string-downcase\".")
		(:name "to-string" :status "done" :type "function" :notes "Renamed from \"string\". Modified. Returns the value of String(value).")
		(:name "to-upper" :status "done" :type "function" :notes "Renamed from \"string-upcase\".")
		...
		(:name "typeof" :status "done" :type "function" :notes "Renamed from \"type-of\". Modified. Simply returns the value of typeof(value).")
