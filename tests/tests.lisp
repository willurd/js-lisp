...
(JSTest.TestCase (object
	...
	:testOneArgument (lambda ()
		(this.assertNotRaises Error (lambda () (first '(one two)))))
	:testManyArguments (lambda ()
		(this.assertRaises Error #'first nil '(one two) "arg 2"))
...
(JSTest.TestCase (object
	...
	:testOneArgument (lambda ()
		(this.assertNotRaises Error (lambda () (second '(one two)))))
	:testManyArguments (lambda ()
		(this.assertRaises Error #'second nil '(one two) "arg 2"))
	:testNonArrayArgument (lambda ()
...
(JSTest.TestCase (object
	...
	:testOneArgument (lambda ()
		(this.assertNotRaises Error (lambda () (third '(one two three)))))
	:testManyArguments (lambda ()
		(this.assertRaises Error #'third nil '(one two three) "arg 2"))
	:testNonArrayArgument (lambda ()
